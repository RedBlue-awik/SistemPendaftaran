    ...
    <style>
       ...
       .btn-primary {
        ...
        .dataTables_filter input {
            background-color: #f0fdf4 !important;
            border-color: #5c5c5c55 !important;
...
<body class="min-h-screen text-text-main">
    ...
    <div id="sidebarOverlay" class="sidebar-overlay fixed inset-0 z-40 hidden lg:hidden" onclick="toggleSidebar()">
    </div>

    <!-- Sidebar -->
    <aside id="sidebar"
        class="fixed left-0 top-0 h-full w-64 bg-surface border-r border-border z-50 transform -translate-x-full lg:translate-x-0 transition-transform duration-300 shadow-lg">
        <div class="flex flex-col h-full">
            ...
            <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
                <a href="{{ route('admin.dashboard') }}"
                    class="menu-item {{ request()->routeIs('admin.dashboard') ? 'active' : '' }} flex items-center gap-3 px-4 py-3 rounded-lg">
                ...
                <a href="{{ route('admin.users.index') }}"
                    class="menu-item {{ request()->routeIs('admin.users.*') ? 'active' : '' }} flex items-center gap-3 px-4 py-3 rounded-lg text-text-secondary hover:text-text-main">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('admin.gelombangs.index') }}"
                    class="menu-item {{ request()->routeIs('admin.gelombangs.*') ? 'active' : '' }} flex items-center gap-3 px-4 py-3 rounded-lg text-text-secondary hover:text-text-main">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('admin.pendaftars.index') }}"
                    class="menu-item {{ request()->routeIs('admin.pendaftars.*') ? 'active' : '' }} flex items-center gap-3 px-4 py-3 rounded-lg text-text-secondary hover:text-text-main">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('admin.jalurs.index') }}"
                    class="menu-item {{ request()->routeIs('admin.jalurs.*') ? 'active' : '' }} flex items-center gap-3 px-4 py-3 rounded-lg text-text-secondary hover:text-text-main">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="flex items-center justify-between px-4 lg:px-8 py-4">
                <div class="flex items-center gap-4">
                    <button id="menuToggle"
                        class="lg:hidden p-2 rounded-lg bg-green-50 hover:bg-green-100 transition-colors"
