            ...
            <div class="w-full">
                ...
                <form action="{{ route('register') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="name" placeholder="Nama Sesuai Ijazah" class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-hijau-utama focus:border-transparent transition" required value="{{ old('name') }}">
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="relative">
                            ...
                            <input type="phone" name="phone" placeholder="08123456789" class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-hijau-utama focus:border-transparent transition" required value="{{ old('phone') }}">
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="relative">
                            ...
                            <input id="password" type="password" name="password" placeholder="Min. 8 karakter" class="w-full pl-10 pr-10 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-hijau-utama focus:border-transparent transition" required>
                ...
                <div class="mt-6 text-center">
                    <p class="text-sm text-gray-500">
                        Sudah punya akun? 
                        <a href="{{ route('login') }}" class="font-semibold text-hijau-utama hover:underline">Masuk di sini</a>
                    </p>
                </div>
            </div>
